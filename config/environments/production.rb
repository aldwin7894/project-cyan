...
Rails.application.configure do
  ...
  config.asset_host = ENV.fetch("RAILS_ASSET_HOST", "https://aldwin7894-prod.s3.us-east-2.amazonaws.com/")
  ...
  # config.active_job.queue_name_prefix = "aldwin7894_production"

...
# pkg:gem/webdrivers#lib/webdrivers/network.rb:5
module Webdrivers
  class << self
    ...
    # pkg:gem/webdrivers#lib/webdrivers/common.rb:48
    def logger; end
...
# pkg:gem/webdrivers#lib/webdrivers/common.rb:20
...
# pkg:gem/webdrivers#lib/webdrivers/chromedriver.rb:8
class Webdrivers::Chromedriver < ::Webdrivers::Common
  class << self
    ...
    # @return [String]
    #
    # pkg:gem/webdrivers#lib/webdrivers/chromedriver.rb:59
    def base_url; end
    ...
    # @return [Gem::Version]
    #
    # pkg:gem/webdrivers#lib/webdrivers/chromedriver.rb:14
    ...
    # @return [Gem::Version]
    #
    # pkg:gem/webdrivers#lib/webdrivers/chromedriver.rb:29
    ...
    # pkg:gem/webdrivers#lib/webdrivers/chromedriver.rb:165
    ...
    #
    # pkg:gem/webdrivers#lib/webdrivers/chromedriver.rb:139
    def current_build_version; end

    # pkg:gem/webdrivers#lib/webdrivers/chromedriver.rb:118
    def direct_url(driver_version); end

    # pkg:gem/webdrivers#lib/webdrivers/chromedriver.rb:180
    def direct_url_from_api(driver_version); end

    # pkg:gem/webdrivers#lib/webdrivers/chromedriver.rb:123
    ...
    # pkg:gem/webdrivers#lib/webdrivers/chromedriver.rb:65
...
# pkg:gem/webdrivers#lib/webdrivers/common.rb:74
class Webdrivers::Common
  class << self
    ...
    # @return [String]
    #
    # pkg:gem/webdrivers#lib/webdrivers/common.rb:115
    def driver_path; end

    # Deletes the existing driver binary.
    #
    # pkg:gem/webdrivers#lib/webdrivers/common.rb:104
    def remove; end
    ...
    #
    # pkg:gem/webdrivers#lib/webdrivers/common.rb:90
    def update; end
    ...
    # pkg:gem/webdrivers#lib/webdrivers/common.rb:125
    ...
    #
    # pkg:gem/webdrivers#lib/webdrivers/common.rb:160
...
# pkg:gem/webdrivers#lib/webdrivers/edgedriver.rb:9
class Webdrivers::Edgedriver < ::Webdrivers::Chromedriver
  class << self
    ...
    # @return [String]
    #
    # pkg:gem/webdrivers#lib/webdrivers/edgedriver.rb:24
    def base_url; end
    ...
    # @return [Gem::Version]
    #
    # pkg:gem/webdrivers#lib/webdrivers/edgedriver.rb:16
    def browser_version; end
    ...
    # pkg:gem/webdrivers#lib/webdrivers/edgedriver.rb:92
    def direct_url(driver_version); end

    # pkg:gem/webdrivers#lib/webdrivers/edgedriver.rb:78
    def driver_filename(driver_version); end

    # pkg:gem/webdrivers#lib/webdrivers/edgedriver.rb:44
    def failed_to_find_message(version); end

    # pkg:gem/webdrivers#lib/webdrivers/edgedriver.rb:64
    def file_name; end

    # pkg:gem/webdrivers#lib/webdrivers/edgedriver.rb:30
    def latest_point_release(version); end
  end
end

# pkg:gem/webdrivers#lib/webdrivers/geckodriver.rb:7
class Webdrivers::Geckodriver < ::Webdrivers::Common
  class << self
    ...
    # @return [String]
    #
    # pkg:gem/webdrivers#lib/webdrivers/geckodriver.rb:35
    def base_url; end
    ...
    # @return [Gem::Version]
    #
    # pkg:gem/webdrivers#lib/webdrivers/geckodriver.rb:13
    def current_version; end
    ...
    # @return [Gem::Version]
    #
    # pkg:gem/webdrivers#lib/webdrivers/geckodriver.rb:27
    def latest_version; end

    private

    # pkg:gem/webdrivers#lib/webdrivers/geckodriver.rb:45
    def direct_url(version); end

    # pkg:gem/webdrivers#lib/webdrivers/geckodriver.rb:41
    def file_name; end

    # pkg:gem/webdrivers#lib/webdrivers/geckodriver.rb:49
    def platform_ext; end
  end
end

# pkg:gem/webdrivers#lib/webdrivers/iedriver.rb:8
class Webdrivers::IEdriver < ::Webdrivers::Common
  class << self
    ...
    # @return [String]
    #
    # pkg:gem/webdrivers#lib/webdrivers/iedriver.rb:36
    def base_url; end
    ...
    # @return [Gem::Version]
    #
    # pkg:gem/webdrivers#lib/webdrivers/iedriver.rb:14
    def current_version; end
    ...
    # @return [Gem::Version]
    #
    # pkg:gem/webdrivers#lib/webdrivers/iedriver.rb:28
    def latest_version; end

    private

    # pkg:gem/webdrivers#lib/webdrivers/iedriver.rb:46
    def direct_url(version); end

    # pkg:gem/webdrivers#lib/webdrivers/iedriver.rb:59
    def download_manifest; end

    # pkg:gem/webdrivers#lib/webdrivers/iedriver.rb:50
    def downloads; end

    # pkg:gem/webdrivers#lib/webdrivers/iedriver.rb:42
    def file_name; end
  end
end
...
# pkg:gem/webdrivers#lib/webdrivers/common.rb:17
class Webdrivers::NetworkError < ::StandardError; end

# pkg:gem/webdrivers#lib/webdrivers/railtie.rb:6
...
# pkg:gem/webdrivers#lib/webdrivers/version.rb:4
Webdrivers::VERSION = T.let(T.unsafe(nil), String)

# pkg:gem/webdrivers#lib/webdrivers/common.rb:14

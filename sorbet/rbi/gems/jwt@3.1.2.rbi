...
module JWT
  ...
  class << self
    ...
    #
    # pkg:gem/jwt#lib/jwt/version.rb:11
    def gem_version; end
...
# numeric
#
# pkg:gem/jwt#lib/jwt/claims/audience.rb:4
module JWT::Claims
  class << self
    ...
    #
    # pkg:gem/jwt#lib/jwt/claims.rb:62
...
#
# pkg:gem/jwt#lib/jwt/claims/audience.rb:6
class JWT::Claims::Audience
  ...
  # @return [nil]
  #
  # pkg:gem/jwt#lib/jwt/claims/audience.rb:20
...
#
# pkg:gem/jwt#lib/jwt/claims/crit.rb:6
class JWT::Claims::Crit
  ...
  # @return [nil]
  #
  # pkg:gem/jwt#lib/jwt/claims/crit.rb:20
  def verify!(context:, **_args); end
...
# @api private
#
# pkg:gem/jwt#lib/jwt/claims/decode_verifier.rb:13
module JWT::Claims::DecodeVerifier
  class << self
    # @api private
    #
    # pkg:gem/jwt#lib/jwt/claims/decode_verifier.rb:29
...
#
# pkg:gem/jwt#lib/jwt/claims/expiration.rb:6
class JWT::Claims::Expiration
  ...
  # @return [nil]
  #
  # pkg:gem/jwt#lib/jwt/claims/expiration.rb:20
  def verify!(context:, **_args); end
...
#
# pkg:gem/jwt#lib/jwt/claims/issuer.rb:6
class JWT::Claims::Issuer
  ...
  # @return [nil]
  #
  # pkg:gem/jwt#lib/jwt/claims/issuer.rb:20
  def verify!(context:, **_args); end
...
#
# pkg:gem/jwt#lib/jwt/claims/jwt_id.rb:6
class JWT::Claims::JwtId
  ...
  # @return [nil]
  #
  # pkg:gem/jwt#lib/jwt/claims/jwt_id.rb:20
  def verify!(context:, **_args); end
...
#
# pkg:gem/jwt#lib/jwt/claims/not_before.rb:6
class JWT::Claims::NotBefore
  ...
  # @return [nil]
  #
  # pkg:gem/jwt#lib/jwt/claims/not_before.rb:20
  def verify!(context:, **_args); end
...
#
# pkg:gem/jwt#lib/jwt/claims/numeric.rb:7
class JWT::Claims::Numeric
  ...
  # @return [nil]
  #
  # pkg:gem/jwt#lib/jwt/claims/numeric.rb:22
...
#
# pkg:gem/jwt#lib/jwt/claims/required.rb:6
class JWT::Claims::Required
  ...
  # @return [nil]
  #
  # pkg:gem/jwt#lib/jwt/claims/required.rb:20
  def verify!(context:, **_args); end
...
#
# pkg:gem/jwt#lib/jwt/claims/subject.rb:6
class JWT::Claims::Subject
  ...
  # @return [nil]
  #
  # pkg:gem/jwt#lib/jwt/claims/subject.rb:20
  def verify!(context:, **_args); end
...
# @api private
#
# pkg:gem/jwt#lib/jwt/claims/verifier.rb:6
module JWT::Claims::Verifier
  class << self
    # @api private
    #
    # pkg:gem/jwt#lib/jwt/claims/verifier.rb:32
    def errors(context, *options); end

    # @api private
    #
    # pkg:gem/jwt#lib/jwt/claims/verifier.rb:24
...
#
# pkg:gem/jwt#lib/jwt/configuration/decode_configuration.rb:4
module JWT::Configuration
  ...
  #
  # pkg:gem/jwt#lib/jwt/configuration.rb:19
  ...
  #
  # pkg:gem/jwt#lib/jwt/configuration.rb:12
  def configure; end
end

# The Container class holds the configuration settings for JWT.
#
# pkg:gem/jwt#lib/jwt/configuration/container.rb:9
...
# pkg:gem/jwt#lib/jwt/configuration/container.rb:37
...
#
# pkg:gem/jwt#lib/jwt/configuration/decode_configuration.rb:6
...
#
# pkg:gem/jwt#lib/jwt/decode.rb:8
class JWT::Decode
  ...
  #
  # pkg:gem/jwt#lib/jwt/decode.rb:35
  ...
  # pkg:gem/jwt#lib/jwt/decode.rb:94
...
#
# pkg:gem/jwt#lib/jwt/encode.rb:7
class JWT::Encode
  ...
  #
  # pkg:gem/jwt#lib/jwt/encode.rb:24
  def segments; end
end
...
module JWT::JWA
  class << self
    ...
    # pkg:gem/jwt#lib/jwt/jwa/signing_algorithm.rb:47
    ...
    # pkg:gem/jwt#lib/jwt/jwa/signing_algorithm.rb:57
    def algorithms; end
  end
end
...
#
# pkg:gem/jwt#lib/jwt/jwa/ecdsa.rb:6
class JWT::JWA::Ecdsa
...
#
# pkg:gem/jwt#lib/jwt/jwa/hmac.rb:6
class JWT::JWA::Hmac
  include ::JWT::JWA::SigningAlgorithm
  extend ::JWT::JWA::SigningAlgorithm::ClassMethods
...
#
# pkg:gem/jwt#lib/jwt/jwa/none.rb:6
class JWT::JWA::None
  include ::JWT::JWA::SigningAlgorithm
  extend ::JWT::JWA::SigningAlgorithm::ClassMethods
...
#
# pkg:gem/jwt#lib/jwt/jwa/ps.rb:6
class JWT::JWA::Ps
  include ::JWT::JWA::SigningAlgorithm
  extend ::JWT::JWA::SigningAlgorithm::ClassMethods
...
#
# pkg:gem/jwt#lib/jwt/jwa/rsa.rb:6
class JWT::JWA::Rsa
  include ::JWT::JWA::SigningAlgorithm
  extend ::JWT::JWA::SigningAlgorithm::ClassMethods
...
#
# pkg:gem/jwt#lib/jwt/jwa/signing_algorithm.rb:7
module JWT::JWA::SigningAlgorithm
  ...
  # pkg:gem/jwt#lib/jwt/jwa/signing_algorithm.rb:37
...
#
# pkg:gem/jwt#lib/jwt/jwa/signing_algorithm.rb:9
module JWT::JWA::SigningAlgorithm::ClassMethods
  # pkg:gem/jwt#lib/jwt/jwa/signing_algorithm.rb:10
  def register_algorithm(algo); end
end

# Represents an unsupported algorithm
#
# pkg:gem/jwt#lib/jwt/jwa/unsupported.rb:6
...
# JSON Web Key (JWK)
#
# pkg:gem/jwt#lib/jwt/jwk/kid_as_key_digest.rb:4
module JWT::JWK
  class << self
    # pkg:gem/jwt#lib/jwt/jwk.rb:25
    def classes; end

    # pkg:gem/jwt#lib/jwt/jwk.rb:10
    def create_from(key, params = T.unsafe(nil), options = T.unsafe(nil)); end

    # pkg:gem/jwt#lib/jwt/jwk.rb:31
    def import(key, params = T.unsafe(nil), options = T.unsafe(nil)); end

    # pkg:gem/jwt#lib/jwt/jwk.rb:30
    def new(key, params = T.unsafe(nil), options = T.unsafe(nil)); end

    private

    # pkg:gem/jwt#lib/jwt/jwk.rb:39
    def generate_mappings; end

    # pkg:gem/jwt#lib/jwt/jwk.rb:35
    def mappings; end
  end
end
...
class JWT::JWK::EC < ::JWT::JWK::KeyBase
  ...
  # pkg:gem/jwt#lib/jwt/jwk/ec.rb:55
  def export(options = T.unsafe(nil)); end

  # pkg:gem/jwt#lib/jwt/jwk/ec.rb:74
  def jwa; end

  # pkg:gem/jwt#lib/jwt/jwk/ec.rb:61
  def key_digest; end

  # pkg:gem/jwt#lib/jwt/jwk/ec.rb:31
  def keypair; end
  ...
  # pkg:gem/jwt#lib/jwt/jwk/ec.rb:47
  def public_key; end

  # pkg:gem/jwt#lib/jwt/jwk/ec.rb:39
  def signing_key; end

  # pkg:gem/jwt#lib/jwt/jwk/ec.rb:43
  def verify_key; end
...
class JWT::JWK::HMAC < ::JWT::JWK::KeyBase
  ...
  #
  # pkg:gem/jwt#lib/jwt/jwk/hmac.rb:48
  def export(options = T.unsafe(nil)); end

  # pkg:gem/jwt#lib/jwt/jwk/hmac.rb:58
  def key_digest; end

  # pkg:gem/jwt#lib/jwt/jwk/hmac.rb:27
  def keypair; end
  ...
  # pkg:gem/jwt#lib/jwt/jwk/hmac.rb:35
  def public_key; end

  # pkg:gem/jwt#lib/jwt/jwk/hmac.rb:43
  def signing_key; end

  # pkg:gem/jwt#lib/jwt/jwk/hmac.rb:39
  def verify_key; end
  ...
  # pkg:gem/jwt#lib/jwt/jwk/hmac.rb:76
  def extract_key_params(key); end

  # pkg:gem/jwt#lib/jwt/jwk/hmac.rb:72
  def secret; end

  class << self
    # pkg:gem/jwt#lib/jwt/jwk/hmac.rb:96
    def import(jwk_data); end
  end
end

# pkg:gem/jwt#lib/jwt/jwk/hmac.rb:11
JWT::JWK::HMAC::HMAC_KEY_ELEMENTS = T.let(T.unsafe(nil), Array)

# pkg:gem/jwt#lib/jwt/jwk/hmac.rb:10
JWT::JWK::HMAC::HMAC_PRIVATE_KEY_ELEMENTS = T.let(T.unsafe(nil), Array)

# pkg:gem/jwt#lib/jwt/jwk/hmac.rb:9
JWT::JWK::HMAC::HMAC_PUBLIC_KEY_ELEMENTS = T.let(T.unsafe(nil), Array)

# pkg:gem/jwt#lib/jwt/jwk/hmac.rb:7
JWT::JWK::HMAC::KTY = T.let(T.unsafe(nil), String)

# pkg:gem/jwt#lib/jwt/jwk/hmac.rb:8
...
class JWT::JWK::KeyBase
  ...
  # pkg:gem/jwt#lib/jwt/jwk/key_base.rb:55
  def <=>(other); end

  # pkg:gem/jwt#lib/jwt/jwk/key_base.rb:41
  def ==(other); end

  # pkg:gem/jwt#lib/jwt/jwk/key_base.rb:33
  def [](key); end

  # pkg:gem/jwt#lib/jwt/jwk/key_base.rb:37
  def []=(key, value); end

  # pkg:gem/jwt#lib/jwt/jwk/key_base.rb:53
  def eql?(other); end
  ...
  # pkg:gem/jwt#lib/jwt/jwk/key_base.rb:49
  def sign(**kwargs); end

  # pkg:gem/jwt#lib/jwt/jwk/key_base.rb:45
...
class JWT::JWK::KeyFinder
  ...
  # pkg:gem/jwt#lib/jwt/jwk/key_finder.rb:58
...
class JWT::JWK::RSA < ::JWT::JWK::KeyBase
  ...
  # pkg:gem/jwt#lib/jwt/jwk/rsa.rb:51
  def export(options = T.unsafe(nil)); end

  # pkg:gem/jwt#lib/jwt/jwk/rsa.rb:62
  def key_digest; end

  # pkg:gem/jwt#lib/jwt/jwk/rsa.rb:31
  def keypair; end
  ...
  # pkg:gem/jwt#lib/jwt/jwk/rsa.rb:39
  def public_key; end

  # pkg:gem/jwt#lib/jwt/jwk/rsa.rb:43
  def signing_key; end

  # pkg:gem/jwt#lib/jwt/jwk/rsa.rb:47
  def verify_key; end
  ...
  # pkg:gem/jwt#lib/jwt/jwk/rsa.rb:126
  def decode_open_ssl_bn(jwk_data); end

  # pkg:gem/jwt#lib/jwt/jwk/rsa.rb:120
  def encode_open_ssl_bn(key_part); end

  # pkg:gem/jwt#lib/jwt/jwk/rsa.rb:80
  def extract_key_params(key); end

  # pkg:gem/jwt#lib/jwt/jwk/rsa.rb:114
  def jwk_attributes(*attributes); end

  # pkg:gem/jwt#lib/jwt/jwk/rsa.rb:100
  def parse_rsa_key(key); end

  # pkg:gem/jwt#lib/jwt/jwk/rsa.rb:76
  def rsa_key; end

  class << self
    # pkg:gem/jwt#lib/jwt/jwk/rsa.rb:197
    def create_rsa_key(rsa_parameters); end

    # :nocov:
    # Before openssl 2.0, we need to use the accessors to set the key
    #
    # pkg:gem/jwt#lib/jwt/jwk/rsa.rb:171
    def create_rsa_key_using_accessors(rsa_parameters); end

    # pkg:gem/jwt#lib/jwt/jwk/rsa.rb:141
    def create_rsa_key_using_der(rsa_parameters); end

    # pkg:gem/jwt#lib/jwt/jwk/rsa.rb:159
    def create_rsa_key_using_sets(rsa_parameters); end

    # pkg:gem/jwt#lib/jwt/jwk/rsa.rb:135
    def decode_open_ssl_bn(jwk_data); end

    # pkg:gem/jwt#lib/jwt/jwk/rsa.rb:131
    def import(jwk_data); end
...
# pkg:gem/jwt#lib/jwt/jwk/rsa.rb:7
JWT::JWK::RSA::BINARY = T.let(T.unsafe(nil), Integer)

# pkg:gem/jwt#lib/jwt/jwk/rsa.rb:8
...
class JWT::JWK::Set
  ...
  # pkg:gem/jwt#lib/jwt/jwk/set.rb:78
  def +(enum); end

  # pkg:gem/jwt#lib/jwt/jwk/set.rb:79
  def <<(key); end

  # pkg:gem/jwt#lib/jwt/jwk/set.rb:69
  def ==(other); end

  # pkg:gem/jwt#lib/jwt/jwk/set.rb:64
  def add(key); end
  ...
  # pkg:gem/jwt#lib/jwt/jwk/set.rb:33
  def export(options = T.unsafe(nil)); end
  ...
  # pkg:gem/jwt#lib/jwt/jwk/set.rb:45
  def reject!(&block); end

  # pkg:gem/jwt#lib/jwt/jwk/set.rb:39
  ...
  # pkg:gem/jwt#lib/jwt/jwk/set.rb:51
  def uniq!(&block); end
...
class JWT::JWK::Thumbprint
  ...
  # pkg:gem/jwt#lib/jwt/jwk/thumbprint.rb:23
  def to_s; end
end
...
#
# pkg:gem/jwt#lib/jwt/token.rb:17
class JWT::Token
  ...
  #
  # pkg:gem/jwt#lib/jwt/token.rb:82
  ...
  #
  # pkg:gem/jwt#lib/jwt/token.rb:49
  def encoded_header; end
  ...
  #
  # pkg:gem/jwt#lib/jwt/token.rb:61
  def encoded_payload; end
  ...
  #
  # pkg:gem/jwt#lib/jwt/token.rb:37
  def encoded_signature; end
  ...
  #
  # pkg:gem/jwt#lib/jwt/token.rb:44
  def header; end
  ...
  #
  # pkg:gem/jwt#lib/jwt/token.rb:56
  def payload; end
  ...
  #
  # pkg:gem/jwt#lib/jwt/token.rb:30
  def signature; end
  ...
  #
  # pkg:gem/jwt#lib/jwt/token.rb:68
  def signing_input; end
...
# Version constants
#
# pkg:gem/jwt#lib/jwt/version.rb:16
module JWT::VERSION; end

# pkg:gem/jwt#lib/jwt/version.rb:17
JWT::VERSION::MAJOR = T.let(T.unsafe(nil), Integer)

# pkg:gem/jwt#lib/jwt/version.rb:18
JWT::VERSION::MINOR = T.let(T.unsafe(nil), Integer)

# pkg:gem/jwt#lib/jwt/version.rb:20
JWT::VERSION::PRE = T.let(T.unsafe(nil), T.untyped)

# pkg:gem/jwt#lib/jwt/version.rb:22
...
class JWT::X5cKeyFinder
  ...
  # pkg:gem/jwt#lib/jwt/x5c_key_finder.rb:15
  def from(x5c_header_or_certificates); end

  private

  # pkg:gem/jwt#lib/jwt/x5c_key_finder.rb:33
  def build_store(root_certificates, crls); end

  # pkg:gem/jwt#lib/jwt/x5c_key_finder.rb:42

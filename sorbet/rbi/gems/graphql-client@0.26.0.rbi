...
# pkg:gem/graphql-client#lib/graphql/client/type_stack.rb:2
module GraphQL; end
...
# Schema object.
#
# pkg:gem/graphql-client#lib/graphql/client/type_stack.rb:3
class GraphQL::Client
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client.rb:46
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client.rb:275
  def get_type(type_name); end

  # pkg:gem/graphql-client#lib/graphql/client.rb:131
  ...
  # pkg:gem/graphql-client#lib/graphql/client.rb:455
  def deep_freeze_json_object(obj); end

  # pkg:gem/graphql-client#lib/graphql/client.rb:468
  def deep_stringify_keys(obj); end

  # pkg:gem/graphql-client#lib/graphql/client.rb:447
  def find_definition_dependencies(node); end

  # pkg:gem/graphql-client#lib/graphql/client.rb:404
  def sliced_definitions(document_dependencies, doc, source_location:); end

  class << self
    # pkg:gem/graphql-client#lib/graphql/client.rb:73
    def dump_schema(schema, io = T.unsafe(nil), context: T.unsafe(nil)); end

    # pkg:gem/graphql-client#lib/graphql/client.rb:48
...
#
# pkg:gem/graphql-client#lib/graphql/client/collocated_enforcement.rb:14
module GraphQL::Client::CollocatedEnforcement
  extend ::GraphQL::Client::CollocatedEnforcement

  # Public: Ignore collocated caller enforcement for the scope of the block.
  #
  # pkg:gem/graphql-client#lib/graphql/client/collocated_enforcement.rb:18
  ...
  # Returns nothing.
  #
  # pkg:gem/graphql-client#lib/graphql/client/collocated_enforcement.rb:49
  def enforce_collocated_callers(mod, methods, path); end

  # pkg:gem/graphql-client#lib/graphql/client/collocated_enforcement.rb:25
...
class GraphQL::Client::Definition < ::Module
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/definition.rb:60
  def client; end
  ...
  # Returns String.
  #
  # pkg:gem/graphql-client#lib/graphql/client/definition.rb:86
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/definition.rb:71
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/definition.rb:101
  def document; end

  # Internal: Nodes AST indexes.
  #
  # pkg:gem/graphql-client#lib/graphql/client/definition.rb:148
  def indexes; end

  # pkg:gem/graphql-client#lib/graphql/client/definition.rb:109
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/definition.rb:65
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/definition.rb:77
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/definition.rb:107
  def source_location; end

  private

  # pkg:gem/graphql-client#lib/graphql/client/definition.rb:222
  def cast_object(obj); end

  class << self
    # pkg:gem/graphql-client#lib/graphql/client/definition.rb:17
...
class GraphQL::Client::Definition::DefinitionVisitor < ::GraphQL::Language::Visitor
  ...
  # pkg:gem/graphql-client#lib/graphql/client/definition.rb:166
  def on_field(node, parent); end

  # pkg:gem/graphql-client#lib/graphql/client/definition.rb:172
  def on_fragment_definition(node, parent); end

  # pkg:gem/graphql-client#lib/graphql/client/definition.rb:190
  ...
  # pkg:gem/graphql-client#lib/graphql/client/definition.rb:204
  def flatten_spreads(node); end

  # pkg:gem/graphql-client#lib/graphql/client/definition.rb:199
  def get_spreads(node); end
end

# pkg:gem/graphql-client#lib/graphql/client/definition.rb:197
...
#
# pkg:gem/graphql-client#lib/graphql/client/definition_variables.rb:7
module GraphQL::Client::DefinitionVariables
  class << self
    ...
    #
    # pkg:gem/graphql-client#lib/graphql/client/definition_variables.rb:64
    ...
    #
    # pkg:gem/graphql-client#lib/graphql/client/definition_variables.rb:75
    ...
    #
    # pkg:gem/graphql-client#lib/graphql/client/definition_variables.rb:16
    def variables(schema, document, definition_name = T.unsafe(nil)); end
  end
end

# pkg:gem/graphql-client#lib/graphql/client/definition_variables.rb:32
...
#
# pkg:gem/graphql-client#lib/graphql/client/document_types.rb:8
module GraphQL::Client::DocumentTypes
  class << self
    ...
    #
    # pkg:gem/graphql-client#lib/graphql/client/document_types.rb:45
    def analyze_types(schema, document); end
  end
end

# pkg:gem/graphql-client#lib/graphql/client/document_types.rb:9
class GraphQL::Client::DocumentTypes::AnalyzeTypesVisitor < ::GraphQL::Language::Visitor
  ...
  # pkg:gem/graphql-client#lib/graphql/client/document_types.rb:33
  def on_field(node, parent); end

  # pkg:gem/graphql-client#lib/graphql/client/document_types.rb:23
  def on_fragment_definition(node, parent); end

  # pkg:gem/graphql-client#lib/graphql/client/document_types.rb:28
  def on_inline_fragment(node, parent); end

  # pkg:gem/graphql-client#lib/graphql/client/document_types.rb:18
  def on_operation_definition(node, parent); end
end

# pkg:gem/graphql-client#lib/graphql/client.rb:27
...
#
# pkg:gem/graphql-client#lib/graphql/client/error.rb:5
...
#
# pkg:gem/graphql-client#lib/graphql/client/errors.rb:9
class GraphQL::Client::Errors
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/errors.rb:122
  def [](key); end
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/errors.rb:95
  def details; end
  ...
  # message.
  #
  # pkg:gem/graphql-client#lib/graphql/client/errors.rb:130
  def each; end
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/errors.rb:179
  def keys; end
  ...
  # Returns HashWithIndifferentAccess.
  #
  # pkg:gem/graphql-client#lib/graphql/client/errors.rb:74
  def messages; end
  ...
  # Returns the number of error messages.
  #
  # pkg:gem/graphql-client#lib/graphql/client/errors.rb:157
  def size; end
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/errors.rb:189
  def values; end
  ...
  class << self
    ...
    # Returns nothing.
    #
    # pkg:gem/graphql-client#lib/graphql/client/errors.rb:20
...
#
# pkg:gem/graphql-client#lib/graphql/client/fragment_definition.rb:8
class GraphQL::Client::FragmentDefinition < ::GraphQL::Client::Definition
  # pkg:gem/graphql-client#lib/graphql/client/fragment_definition.rb:9
...
class GraphQL::Client::GatherNamesVisitor < ::GraphQL::Language::Visitor
  ...
  # pkg:gem/graphql-client#lib/graphql/client.rb:441
...
#
# pkg:gem/graphql-client#lib/graphql/client/http.rb:20
class GraphQL::Client::HTTP
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/http.rb:91
  def connection; end
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/http.rb:63
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/http.rb:44
  ...
  # Returns Hash.
  #
  # pkg:gem/graphql-client#lib/graphql/client/http.rb:51
  ...
  # Returns URI.
  #
  # pkg:gem/graphql-client#lib/graphql/client/http.rb:39
  def uri; end
end
...
#
# pkg:gem/graphql-client#lib/graphql/client/hash_with_indifferent_access.rb:11
class GraphQL::Client::HashWithIndifferentAccess
  ...
  # pkg:gem/graphql-client#lib/graphql/client/hash_with_indifferent_access.rb:31
  def [](key); end
  ...
  # pkg:gem/graphql-client#lib/graphql/client/hash_with_indifferent_access.rb:52
  def convert_value(key); end
end

# pkg:gem/graphql-client#lib/graphql/client/error.rb:11
class GraphQL::Client::ImplicitlyFetchedFieldError < ::NoMethodError; end

# pkg:gem/graphql-client#lib/graphql/client.rb:71
GraphQL::Client::IntrospectionDocument = T.let(T.unsafe(nil), GraphQL::Language::Nodes::Document)

# pkg:gem/graphql-client#lib/graphql/client/error.rb:8
...
module GraphQL::Client::LazyName
  ...
  # pkg:gem/graphql-client#lib/graphql/client.rb:395
  def name; end
end
...
class GraphQL::Client::List < ::Array
  ...
  # Returns Errors collection.
  #
  # pkg:gem/graphql-client#lib/graphql/client/list.rb:17
  def errors; end
end

# Raised when method is called from outside the expected file scope.
#
# pkg:gem/graphql-client#lib/graphql/client/collocated_enforcement.rb:11
class GraphQL::Client::NonCollocatedCallerError < ::GraphQL::Client::Error; end

# pkg:gem/graphql-client#lib/graphql/client.rb:28
...
# subscriptions.
#
# pkg:gem/graphql-client#lib/graphql/client/operation_definition.rb:9
class GraphQL::Client::OperationDefinition < ::GraphQL::Client::Definition
  # Public: Alias for definition name.
  #
  # pkg:gem/graphql-client#lib/graphql/client/operation_definition.rb:11
  def operation_name; end
end

# Internal: Insert __typename field selections into query.
#
# pkg:gem/graphql-client#lib/graphql/client/query_typename.rb:8
module GraphQL::Client::QueryTypename
  class << self
    # pkg:gem/graphql-client#lib/graphql/client/query_typename.rb:60
    def insert_typename_fields(document, types: T.unsafe(nil)); end

    # pkg:gem/graphql-client#lib/graphql/client/query_typename.rb:96
...
class GraphQL::Client::QueryTypename::InsertTypenameVisitor < ::GraphQL::Language::Visitor
  ...
  # pkg:gem/graphql-client#lib/graphql/client/query_typename.rb:27
  def add_typename(node, parent); end

  # pkg:gem/graphql-client#lib/graphql/client/query_typename.rb:51
  def on_field(node, parent); end

  # pkg:gem/graphql-client#lib/graphql/client/query_typename.rb:55
  def on_fragment_definition(node, parent); end

  # pkg:gem/graphql-client#lib/graphql/client/query_typename.rb:47
  def on_operation_definition(node, parent); end
end
...
class GraphQL::Client::RenameNodeVisitor < ::GraphQL::Language::Visitor
  ...
  # pkg:gem/graphql-client#lib/graphql/client.rb:248
  def on_fragment_definition(node, _parent); end

  # pkg:gem/graphql-client#lib/graphql/client.rb:258
  def on_fragment_spread(node, _parent); end

  # pkg:gem/graphql-client#lib/graphql/client.rb:253
  def on_operation_definition(node, _parent); end

  private

  # pkg:gem/graphql-client#lib/graphql/client.rb:265
...
class GraphQL::Client::Response
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/response.rb:22
  def data; end
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/response.rb:29
  def errors; end

  # Public: Hash of server specific extension metadata.
  #
  # pkg:gem/graphql-client#lib/graphql/client/response.rb:32
  def extensions; end
  ...
  # Returns Hash
  #
  # pkg:gem/graphql-client#lib/graphql/client/response.rb:37
...
# pkg:gem/graphql-client#lib/graphql/client/schema/base_type.rb:5
module GraphQL::Client::Schema
  class << self
    # pkg:gem/graphql-client#lib/graphql/client/schema.rb:86
    def class_for(schema, type, cache); end

    # pkg:gem/graphql-client#lib/graphql/client/schema.rb:69
    def generate(schema, raise_on_unknown_enum_value: T.unsafe(nil)); end
  end
end

# pkg:gem/graphql-client#lib/graphql/client/schema/base_type.rb:6
module GraphQL::Client::Schema::BaseType
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/schema/base_type.rb:11
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/schema/base_type.rb:33
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/schema/base_type.rb:26
  def to_non_null_type; end

  # Public: Get associated GraphQL::BaseType with for this class.
  #
  # pkg:gem/graphql-client#lib/graphql/client/schema/base_type.rb:8
  def type; end
end

# pkg:gem/graphql-client#lib/graphql/client/schema.rb:17
module GraphQL::Client::Schema::ClassMethods
  # pkg:gem/graphql-client#lib/graphql/client/schema.rb:18
  def define_class(definition, ast_nodes, type); end

  # pkg:gem/graphql-client#lib/graphql/client/schema.rb:58
  def directives; end

  # pkg:gem/graphql-client#lib/graphql/client/schema.rb:39
  def get_class(type_name); end

  # pkg:gem/graphql-client#lib/graphql/client/schema.rb:43
  def set_class(type_name, klass); end

  private

  # pkg:gem/graphql-client#lib/graphql/client/schema.rb:64
  def normalize_type_name(type_name); end
end

# pkg:gem/graphql-client#lib/graphql/client/schema.rb:55
GraphQL::Client::Schema::ClassMethods::DIRECTIVES = T.let(T.unsafe(nil), Hash)

# pkg:gem/graphql-client#lib/graphql/client/schema/enum_type.rb:9
class GraphQL::Client::Schema::EnumType < ::Module
  ...
  # pkg:gem/graphql-client#lib/graphql/client/schema/enum_type.rb:77
  def [](value); end
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/schema/enum_type.rb:88
  def cast(value, _errors = T.unsafe(nil)); end

  # pkg:gem/graphql-client#lib/graphql/client/schema/enum_type.rb:73
...
# pkg:gem/graphql-client#lib/graphql/client/schema/include_directive.rb:8
class GraphQL::Client::Schema::IncludeDirective
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/schema/include_directive.rb:33
  def cast(value, errors); end
  ...
  # Returns BaseType instance.
  #
  # pkg:gem/graphql-client#lib/graphql/client/schema/include_directive.rb:25
  def of_klass; end
end

# pkg:gem/graphql-client#lib/graphql/client/schema/interface_type.rb:8
class GraphQL::Client::Schema::InterfaceType < ::Module
  ...
  # pkg:gem/graphql-client#lib/graphql/client/schema/interface_type.rb:23
  def define_class(definition, ast_nodes); end

  # pkg:gem/graphql-client#lib/graphql/client/schema/interface_type.rb:19
  def new(types); end
end

# pkg:gem/graphql-client#lib/graphql/client/schema/list_type.rb:10
class GraphQL::Client::Schema::ListType
  ...
  # Returns List instance or nil.
  #
  # pkg:gem/graphql-client#lib/graphql/client/schema/list_type.rb:35
  ...
  # Returns BaseType instance.
  #
  # pkg:gem/graphql-client#lib/graphql/client/schema/list_type.rb:27
  def of_klass; end
  ...
  # Returns ListType instance.
  #
  # pkg:gem/graphql-client#lib/graphql/client/schema/list_type.rb:51
  def to_list_type; end
end

# pkg:gem/graphql-client#lib/graphql/client/schema/non_null_type.rb:9
class GraphQL::Client::Schema::NonNullType
  ...
  # Returns BaseType instance.
  #
  # pkg:gem/graphql-client#lib/graphql/client/schema/non_null_type.rb:34
  def cast(value, errors); end
  ...
  # Returns BaseType instance.
  #
  # pkg:gem/graphql-client#lib/graphql/client/schema/non_null_type.rb:26
  def of_klass; end
  ...
  # Returns NonNullType instance.
  #
  # pkg:gem/graphql-client#lib/graphql/client/schema/non_null_type.rb:46
  def to_non_null_type; end
end
...
class GraphQL::Client::Schema::ObjectClass
  ...
  # pkg:gem/graphql-client#lib/graphql/client/schema/object_type.rb:196
  def _definer; end

  # pkg:gem/graphql-client#lib/graphql/client/schema/object_type.rb:200
  def _spreads; end
  ...
  # Returns Errors collection.
  #
  # pkg:gem/graphql-client#lib/graphql/client/schema/object_type.rb:223
  def errors; end

  # pkg:gem/graphql-client#lib/graphql/client/schema/object_type.rb:270
  def inspect; end

  # pkg:gem/graphql-client#lib/graphql/client/schema/object_type.rb:231
  def method_missing(name, *args); end

  # pkg:gem/graphql-client#lib/graphql/client/schema/object_type.rb:204
  ...
  # pkg:gem/graphql-client#lib/graphql/client/schema/object_type.rb:292
  def verify_collocated_path; end
end

# pkg:gem/graphql-client#lib/graphql/client/schema/object_type.rb:10
module GraphQL::Client::Schema::ObjectType
  # pkg:gem/graphql-client#lib/graphql/client/schema/object_type.rb:115
  def cast(value, errors); end

  # pkg:gem/graphql-client#lib/graphql/client/schema/object_type.rb:68
  def define_class(definition, ast_nodes); end

  # pkg:gem/graphql-client#lib/graphql/client/schema/object_type.rb:100
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/schema/object_type.rb:130
  def gather_selections(fields, definition, selected_ast_node); end

  class << self
    # pkg:gem/graphql-client#lib/graphql/client/schema/object_type.rb:11
    def new(type, fields = T.unsafe(nil)); end
  end
end

# pkg:gem/graphql-client#lib/graphql/client/schema/object_type.rb:24
class GraphQL::Client::Schema::ObjectType::WithDefinition
  ...
  # pkg:gem/graphql-client#lib/graphql/client/schema/object_type.rb:63
  def new(data = T.unsafe(nil), errors = T.unsafe(nil)); end

  # pkg:gem/graphql-client#lib/graphql/client/schema/object_type.rb:40
  def spreads; end

  # pkg:gem/graphql-client#lib/graphql/client/schema/object_type.rb:32
  def type; end
end

# pkg:gem/graphql-client#lib/graphql/client/schema/object_type.rb:28
GraphQL::Client::Schema::ObjectType::WithDefinition::EMPTY_SET = T.let(T.unsafe(nil), Set)

# pkg:gem/graphql-client#lib/graphql/client/schema/possible_types.rb:10
...
# pkg:gem/graphql-client#lib/graphql/client/schema/scalar_type.rb:8
class GraphQL::Client::Schema::ScalarType
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/schema/scalar_type.rb:32
  def cast(value, _errors = T.unsafe(nil)); end

  # pkg:gem/graphql-client#lib/graphql/client/schema/scalar_type.rb:22
  def define_class(definition, ast_nodes); end
end

# pkg:gem/graphql-client#lib/graphql/client/schema/skip_directive.rb:8
class GraphQL::Client::Schema::SkipDirective
  ...
  # Returns List instance or nil.
  #
  # pkg:gem/graphql-client#lib/graphql/client/schema/skip_directive.rb:33
  def cast(value, errors); end
  ...
  # Returns BaseType instance.
  #
  # pkg:gem/graphql-client#lib/graphql/client/schema/skip_directive.rb:25
  def of_klass; end
end

# pkg:gem/graphql-client#lib/graphql/client/schema/union_type.rb:8
class GraphQL::Client::Schema::UnionType < ::Module
  ...
  # pkg:gem/graphql-client#lib/graphql/client/schema/union_type.rb:23
  def define_class(definition, ast_nodes); end

  # pkg:gem/graphql-client#lib/graphql/client/schema/union_type.rb:19
  def new(types); end
end

# pkg:gem/graphql-client#lib/graphql/client/type_stack.rb:4
module GraphQL::Client::TypeStack
  ...
  #
  # pkg:gem/graphql-client#lib/graphql/client/type_stack.rb:30
  def initialize(document, schema:, **rest); end

  # @return [Array<GraphQL::Node::Argument>] arguments which have been entered
  #
  # pkg:gem/graphql-client#lib/graphql/client/type_stack.rb:23
  ...
  # pkg:gem/graphql-client#lib/graphql/client/type_stack.rb:68
  def on_argument(node, parent); end

  # pkg:gem/graphql-client#lib/graphql/client/type_stack.rb:40
  def on_directive(node, parent); end

  # pkg:gem/graphql-client#lib/graphql/client/type_stack.rb:48
  def on_field(node, parent); end

  # pkg:gem/graphql-client#lib/graphql/client/type_stack.rb:119
  def on_fragment_definition(node, parent); end

  # pkg:gem/graphql-client#lib/graphql/client/type_stack.rb:136
  def on_fragment_spread(node, parent); end

  # pkg:gem/graphql-client#lib/graphql/client/type_stack.rb:102
  def on_inline_fragment(node, parent); end

  # pkg:gem/graphql-client#lib/graphql/client/type_stack.rb:91
  def on_operation_definition(node, parent); end

  # @return [Array<String>] fields which have been entered (by their AST name)
  #
  # pkg:gem/graphql-client#lib/graphql/client/type_stack.rb:26
  def path; end

  # @return [GraphQL::Schema] the schema whose types are present in this document
  #
  # pkg:gem/graphql-client#lib/graphql/client/type_stack.rb:6
  def schema; end
end

# pkg:gem/graphql-client#lib/graphql/client/error.rb:14
class GraphQL::Client::UnfetchedFieldError < ::NoMethodError; end

# pkg:gem/graphql-client#lib/graphql/client/error.rb:17
class GraphQL::Client::UnimplementedFieldError < ::NoMethodError; end

# pkg:gem/graphql-client#lib/graphql/client.rb:29
...
#
# pkg:gem/graphql-client#lib/graphql/client/collocated_enforcement.rb:8

...
#
# pkg:gem/rack-mini-profiler#lib/patches/db/mongo.rb:4
class Mongo::Server::Connection < ::Mongo::Server::ConnectionBase
  # pkg:gem/rack-mini-profiler#lib/patches/db/mongo.rb:16
  def dispatch(*args, &blk); end

  # pkg:gem/rack-mini-profiler#lib/patches/db/mongo.rb:5
  def dispatch_with_timing(*args, &blk); end

  # TODO: change to Module#prepend as soon as Ruby 1.9.3 support is dropped
  #
  # pkg:gem/rack-mini-profiler#lib/patches/db/mongo.rb:15
...
#
# pkg:gem/rack-mini-profiler#lib/mini_profiler/version.rb:3
module Rack; end

# pkg:gem/rack-mini-profiler#lib/mini_profiler/version.rb:4
class Rack::MiniProfiler
  ...
  class << self
    # pkg:gem/rack-mini-profiler#lib/mini_profiler.rb:55
    def add_snapshot_custom_field(key, value); end

    # pkg:gem/rack-mini-profiler#lib/mini_profiler.rb:91
    def advanced_tools_message; end

    # pkg:gem/rack-mini-profiler#lib/mini_profiler.rb:79
    def authorize_request; end

    # pkg:gem/rack-mini-profiler#lib/mini_profiler.rb:97
    def binds_to_params(binds); end

    # So we can change the configuration if we want
    #
    # pkg:gem/rack-mini-profiler#lib/mini_profiler.rb:40
    def config; end

    # pkg:gem/rack-mini-profiler#lib/mini_profiler.rb:70
    def create_current(env = T.unsafe(nil), options = T.unsafe(nil)); end

    # pkg:gem/rack-mini-profiler#lib/mini_profiler.rb:44
    def current; end

    # pkg:gem/rack-mini-profiler#lib/mini_profiler.rb:48
    def current=(c); end

    # pkg:gem/rack-mini-profiler#lib/mini_profiler.rb:83
    def deauthorize_request; end

    # discard existing results, don't track this request
    #
    # pkg:gem/rack-mini-profiler#lib/mini_profiler.rb:66
    def discard_results; end

    # pkg:gem/rack-mini-profiler#lib/mini_profiler.rb:31
    def generate_id; end
...
# pkg:gem/rack-mini-profiler#lib/mini_profiler/asset_version.rb:4
Rack::MiniProfiler::ASSET_VERSION = T.let(T.unsafe(nil), String)

# pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/abstract_store.rb:5
class Rack::MiniProfiler::AbstractStore
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/abstract_store.rb:34
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/abstract_store.rb:79
  def snapshots_group(group_name); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/abstract_store.rb:71
  def snapshots_overview; end
end

# maximum age of allowed tokens before cycling in seconds
#
# pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/abstract_store.rb:8
Rack::MiniProfiler::AbstractStore::MAX_TOKEN_AGE = T.let(T.unsafe(nil), Integer)

# pkg:gem/rack-mini-profiler#lib/mini_profiler/actions.rb:4
module Rack::MiniProfiler::Actions
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/actions.rb:54
  def serve_file(env, file_name:); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/actions.rb:104
  def serve_flamegraph(env); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/actions.rb:122
  def serve_profile_gc(env, client_settings); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/actions.rb:128
  def serve_profile_memory(env, client_settings); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/actions.rb:67
  def serve_results(env); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/actions.rb:5
...
class Rack::MiniProfiler::ClientSettings
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/client_settings.rb:84
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/client_settings.rb:58
  def write!(headers); end
end

# pkg:gem/rack-mini-profiler#lib/mini_profiler/client_settings.rb:9
Rack::MiniProfiler::ClientSettings::BACKTRACE_DEFAULT = T.let(T.unsafe(nil), T.untyped)

# pkg:gem/rack-mini-profiler#lib/mini_profiler/client_settings.rb:10
Rack::MiniProfiler::ClientSettings::BACKTRACE_FULL = T.let(T.unsafe(nil), Integer)

# pkg:gem/rack-mini-profiler#lib/mini_profiler/client_settings.rb:11
Rack::MiniProfiler::ClientSettings::BACKTRACE_NONE = T.let(T.unsafe(nil), Integer)

# pkg:gem/rack-mini-profiler#lib/mini_profiler/client_settings.rb:7
...
class Rack::MiniProfiler::Config
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/config.rb:127
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/config.rb:131
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/config.rb:123
  def vertical_position; end

  class << self
    # pkg:gem/rack-mini-profiler#lib/mini_profiler/config.rb:6
    def attr_accessor(*vars); end

    # pkg:gem/rack-mini-profiler#lib/mini_profiler/config.rb:12
    def attributes; end

    # pkg:gem/rack-mini-profiler#lib/mini_profiler/config.rb:16
    def default; end
  end
end
...
class Rack::MiniProfiler::FileStore < ::Rack::MiniProfiler::AbstractStore
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/file_store.rb:145
  def allowed_tokens; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/file_store.rb:161
  def cleanup_cache; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/file_store.rb:139
  def flush_tokens; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/file_store.rb:133
  def get_unviewed_ids(user); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/file_store.rb:102
  def load(id); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/file_store.rb:96
  def save(page_struct); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/file_store.rb:127
  def set_all_unviewed(user, ids); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/file_store.rb:108
  def set_unviewed(user, id); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/file_store.rb:117
  def set_viewed(user, id); end
end

# Sub-class thread so we have a named thread (useful for debugging in Thread.list).
#
# pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/file_store.rb:10
class Rack::MiniProfiler::FileStore::CacheCleanupThread < ::Thread; end

# pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/file_store.rb:49
...
class Rack::MiniProfiler::FileStore::FileCache
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/file_store.rb:19
  def [](key); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/file_store.rb:30
  def []=(key, val); end

  private

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/file_store.rb:43
  def path(key); end
end
...
class Rack::MiniProfiler::GCProfiler
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/gc_profiler.rb:63
  def analyze_growth(ids_before, ids_after); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/gc_profiler.rb:79
  def analyze_initial_state(ids_before); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/gc_profiler.rb:51
  def analyze_strings(ids_before, ids_after); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/gc_profiler.rb:39
  def diff_object_stats(before, after); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/gc_profiler.rb:10
  def object_space_stats; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/gc_profiler.rb:94
...
class Rack::MiniProfiler::MemcacheStore < ::Rack::MiniProfiler::AbstractStore
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memcache_store.rb:73
  def allowed_tokens; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memcache_store.rb:69
  def flush_tokens; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memcache_store.rb:65
  def get_unviewed_ids(user); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memcache_store.rb:34
  def load(id); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memcache_store.rb:30
  def save(page_struct); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memcache_store.rb:61
  def set_all_unviewed(user, ids); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memcache_store.rb:41
  def set_unviewed(user, id); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memcache_store.rb:51
  def set_viewed(user, id); end
end

# pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memcache_store.rb:7
Rack::MiniProfiler::MemcacheStore::EXPIRES_IN_SECONDS = T.let(T.unsafe(nil), Integer)

# pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memcache_store.rb:8
...
class Rack::MiniProfiler::MemoryStore < ::Rack::MiniProfiler::AbstractStore
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memory_store.rb:132
  def allowed_tokens; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memory_store.rb:125
  def cleanup_cache; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memory_store.rb:204
  def fetch_snapshots_group(group_name); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memory_store.rb:190
  def fetch_snapshots_overview; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memory_store.rb:119
  def get_unviewed_ids(user); end

  # FIXME: use weak ref, trouble it may be broken in 1.9 so need to use the 'ref' gem
  #
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memory_store.rb:76
  def initialize_cleanup_thread(args = T.unsafe(nil)); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memory_store.rb:65
  def initialize_locks; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memory_store.rb:93
  def load(id); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memory_store.rb:215
  def load_snapshot(id, group_name); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memory_store.rb:158
  def push_snapshot(page_struct, group_name, config); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memory_store.rb:87
  def save(page_struct); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memory_store.rb:113
  def set_all_unviewed(user, ids); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memory_store.rb:99
  def set_unviewed(user, id); end
  ...
  # used in tests only
  #
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memory_store.rb:227
  def wipe_snapshots_data; end
end

# pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memory_store.rb:50
Rack::MiniProfiler::MemoryStore::CLEANUP_CYCLE = T.let(T.unsafe(nil), Integer)

# pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memory_store.rb:49
...
class Rack::MiniProfiler::MemoryStore::CacheCleanupThread < ::Thread
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memory_store.rb:34
  def cleanup; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memory_store.rb:39
  def cycle_count; end
  ...
  #
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memory_store.rb:28
  def sleepy_run; end
end

# pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/memory_store.rb:48
Rack::MiniProfiler::MemoryStore::EXPIRES_IN_SECONDS = T.let(T.unsafe(nil), Integer)

# pkg:gem/rack-mini-profiler#lib/mini_profiler/profiling_methods.rb:5
module Rack::MiniProfiler::ProfilingMethods
  ...
  #
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/profiling_methods.rb:148
  def counter(type, duration_ms = T.unsafe(nil)); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/profiling_methods.rb:69
  def counter_method(klass, method, &blk); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/profiling_methods.rb:32
  def finish_step(obj); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/profiling_methods.rb:77
  def profile_method(klass, method, type = T.unsafe(nil), &blk); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/profiling_methods.rb:129
  def profile_singleton_method(klass, method, type = T.unsafe(nil), &blk); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/profiling_methods.rb:7
  def record_sql(query, elapsed_ms, params = T.unsafe(nil), cached = T.unsafe(nil)); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/profiling_methods.rb:21
  def report_reader_duration(elapsed_ms, row_count = T.unsafe(nil), class_name = T.unsafe(nil)); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/profiling_methods.rb:25
  def start_step(name); end

  # perform a profiling step on given block
  #
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/profiling_methods.rb:40
  def step(name, opts = T.unsafe(nil)); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/profiling_methods.rb:73
  def uncounter_method(klass, method); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/profiling_methods.rb:55
  def unprofile_method(klass, method); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/profiling_methods.rb:133
  def unprofile_singleton_method(klass, method); end

  private

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/profiling_methods.rb:162
...
class Rack::MiniProfiler::RedisStore < ::Rack::MiniProfiler::AbstractStore
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:88
  def allowed_tokens; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:71
  def diagnostics(user); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:231
  def fetch_snapshots_group(group_name); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:207
  def fetch_snapshots_overview; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:79
  def flush_tokens; end

  # Remove expired ids from the unviewed sorted set and return the remaining ids
  #
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:65
  def get_unviewed_ids(user); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:25
  def load(id); end
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:137
  def push_snapshot(page_struct, group_name, config); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:21
  def save(page_struct); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:48
  def set_all_unviewed(user, ids); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:39
  def set_unviewed(user, id); end
  ...
  #
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:84
  def simulate_expire; end

  private

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:299
  def cached_redis_eval(script, script_sha, reraise: T.unsafe(nil), argv: T.unsafe(nil), keys: T.unsafe(nil)); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:311
  def cleanup_corrupt_snapshots(corrupt_snapshots_ids, group_name); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:289
  def group_snapshot_hash_key(group_name); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:283
  def group_snapshot_zset_key(group_name); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:268
  def prefixed_id(id); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:272
  def redis; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:279
  def snapshot_counter_key; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:295
  def snapshot_overview_zset_key; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:264
  def user_key(user); end

  # only used in tests
  #
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:342
  def wipe_snapshots_data; end
end

# pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:116
Rack::MiniProfiler::RedisStore::COUNTER_LUA = T.let(T.unsafe(nil), String)

# pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:125
Rack::MiniProfiler::RedisStore::COUNTER_LUA_SHA = T.let(T.unsafe(nil), String)

# pkg:gem/rack-mini-profiler#lib/mini_profiler/storage/redis_store.rb:12
Rack::MiniProfiler::RedisStore::EXPIRES_IN_SECONDS = T.let(T.unsafe(nil), Integer)

# pkg:gem/rack-mini-profiler#lib/mini_profiler/version.rb:6
...
class Rack::MiniProfiler::SnapshotsTransporter
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/snapshots_transporter.rb:91
  def requests_interval; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/snapshots_transporter.rb:43
  def ship(snapshot); end

  private

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/snapshots_transporter.rb:97
  def backoff_delay; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/snapshots_transporter.rb:102
  def start_thread; end

  class << self
    # pkg:gem/rack-mini-profiler#lib/mini_profiler/snapshots_transporter.rb:17
    def failed_http_requests_count; end

    # pkg:gem/rack-mini-profiler#lib/mini_profiler/snapshots_transporter.rb:13
    def successful_http_requests_count; end

    # pkg:gem/rack-mini-profiler#lib/mini_profiler/snapshots_transporter.rb:21
    def transport(snapshot); end

    # pkg:gem/rack-mini-profiler#lib/mini_profiler/snapshots_transporter.rb:9
...
#
# pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/base.rb:7
...
class Rack::MiniProfiler::TimerStruct::Base
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/base.rb:19
  def [](name); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/base.rb:23
  def []=(name, val); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/base.rb:33
  def as_json(options = T.unsafe(nil)); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/base.rb:15
  def attributes; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/base.rb:27
  def to_json(*a); end
end
...
class Rack::MiniProfiler::TimerStruct::Client < ::Rack::MiniProfiler::TimerStruct::Base
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/client.rb:31
  def redirect_count; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/client.rb:35
  def timings; end

  class << self
    # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/client.rb:39
    def init_from_form_data(env, page_struct); end

    # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/client.rb:10
    def init_instrumentation; end

    # used by Railtie to instrument asset_tag for JS / CSS
    #
    # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/client.rb:19
...
class Rack::MiniProfiler::TimerStruct::Page < ::Rack::MiniProfiler::TimerStruct::Base
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/page.rb:124
  def attributes_to_serialize; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/page.rb:112
  def duration_ms; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/page.rb:116
  def duration_ms_in_sql; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/page.rb:136
  def extra_json; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/page.rb:100
  def name; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/page.rb:104
  def page_name(env); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/page.rb:120
  def root; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/page.rb:128
  def to_json(*a); end

  class << self
    # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/page.rb:14
    def from_hash(hash); end

    private

    # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/page.rb:45
    def symbolize_array(array); end

    # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/page.rb:30
...
class Rack::MiniProfiler::TimerStruct::Request < ::Rack::MiniProfiler::TimerStruct::Base
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/request.rb:81
  def add_child(name); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/request.rb:135
  def add_custom(type, elapsed_ms, page); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/request.rb:104
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/request.rb:179
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/request.rb:73
  def custom_timings; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/request.rb:65
  def depth; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/request.rb:53
  def duration_ms; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/request.rb:57
  def duration_ms_in_sql; end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/request.rb:90
  def move_child(child, destination); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/request.rb:152
  def move_custom(type, custom, destination); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/request.rb:116
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/request.rb:172
  def record_time(milliseconds = T.unsafe(nil)); end

  # please call SqlTiming#report_reader_duration instead
  #
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/request.rb:130
  def report_reader_duration(elapsed_ms, row_count = T.unsafe(nil), class_name = T.unsafe(nil)); end
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/request.rb:61
  def start_ms; end

  class << self
    # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/request.rb:8
...
class Rack::MiniProfiler::TimerStruct::Sql < ::Rack::MiniProfiler::TimerStruct::Base
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/sql.rb:57
  def report_reader_duration(elapsed_ms, row_count = T.unsafe(nil), class_name = T.unsafe(nil)); end

  # pkg:gem/rack-mini-profiler#lib/mini_profiler/timer_struct/sql.rb:67
  def trim_binds(binds); end
end

# pkg:gem/rack-mini-profiler#lib/mini_profiler/version.rb:5
...
module Rack::MiniProfilerRailsMethods
  ...
  # pkg:gem/rack-mini-profiler#lib/mini_profiler_rails/railtie_methods.rb:54
...
# pkg:gem/rack-mini-profiler#lib/patches/sql_patches.rb:3
class SqlPatches
  class << self
    ...
    # pkg:gem/rack-mini-profiler#lib/patches/sql_patches.rb:22
    def elapsed_time(start_time); end

    # pkg:gem/rack-mini-profiler#lib/patches/sql_patches.rb:49
    ...
    # pkg:gem/rack-mini-profiler#lib/patches/sql_patches.rb:30
    def sql_patches; end
  end
end

...
# pkg:gem/rack-cors#lib/rack/cors/resources/cors_misconfiguration_error.rb:3
module Rack; end
...
class Rack::Cors
  ...
  # pkg:gem/rack-cors#lib/rack/cors.rb:56
  def allow(&block); end
  ...
  # pkg:gem/rack-cors#lib/rack/cors.rb:167
  def all_resources; end

  # pkg:gem/rack-cors#lib/rack/cors.rb:134
  def debug(env, message = T.unsafe(nil), &block); end

  # pkg:gem/rack-cors#lib/rack/cors.rb:155
  def evaluate_path(env); end

  # pkg:gem/rack-cors#lib/rack/cors.rb:204
  def match_resource(path, env); end

  # pkg:gem/rack-cors#lib/rack/cors.rb:183
  def process_cors(env, path); end

  # pkg:gem/rack-cors#lib/rack/cors.rb:171
  def process_preflight(env, path); end

  # pkg:gem/rack-cors#lib/rack/cors.rb:196
  def resource_for_path(path_info); end

  # pkg:gem/rack-cors#lib/rack/cors.rb:138
...
class Rack::Cors::Resource
  ...
  # pkg:gem/rack-cors#lib/rack/cors/resource.rb:47
  ...
  # pkg:gem/rack-cors#lib/rack/cors/resource.rb:107
  def compile(path); end

  # pkg:gem/rack-cors#lib/rack/cors/resource.rb:101
  def ensure_enum(var); end

  # pkg:gem/rack-cors#lib/rack/cors/resource.rb:131
  def header_proc; end
  ...
  # pkg:gem/rack-cors#lib/rack/cors/resource.rb:84
...
#
# pkg:gem/rack-cors#lib/rack/cors/resource.rb:8
Rack::Cors::Resource::CORS_SIMPLE_HEADERS = T.let(T.unsafe(nil), Array)

# pkg:gem/rack-cors#lib/rack/cors/resources/cors_misconfiguration_error.rb:6
class Rack::Cors::Resource::CorsMisconfigurationError < ::StandardError
  # pkg:gem/rack-cors#lib/rack/cors/resources/cors_misconfiguration_error.rb:7
  def message; end
end
...
class Rack::Cors::Resources
  ...
  # pkg:gem/rack-cors#lib/rack/cors/resources.rb:53
  def match_resource(path, env); end
  ...
  # pkg:gem/rack-cors#lib/rack/cors/resources.rb:31
...
# pkg:gem/rack-cors#lib/rack/cors/result.rb:5
class Rack::Cors::Result
  ...
  class << self
    # pkg:gem/rack-cors#lib/rack/cors/result.rb:30
    def hit(env); end

    # pkg:gem/rack-cors#lib/rack/cors/result.rb:37
    def miss(env, reason); end

    # pkg:gem/rack-cors#lib/rack/cors/result.rb:45
    def preflight(env); end
  end
end

# pkg:gem/rack-cors#lib/rack/cors/result.rb:6
Rack::Cors::Result::HEADER_KEY = T.let(T.unsafe(nil), String)

# pkg:gem/rack-cors#lib/rack/cors/result.rb:13
Rack::Cors::Result::MISS_DENY_HEADER = T.let(T.unsafe(nil), String)

# pkg:gem/rack-cors#lib/rack/cors/result.rb:12
Rack::Cors::Result::MISS_DENY_METHOD = T.let(T.unsafe(nil), String)

# pkg:gem/rack-cors#lib/rack/cors/result.rb:11
Rack::Cors::Result::MISS_NO_METHOD = T.let(T.unsafe(nil), String)

# pkg:gem/rack-cors#lib/rack/cors/result.rb:8
Rack::Cors::Result::MISS_NO_ORIGIN = T.let(T.unsafe(nil), String)

# pkg:gem/rack-cors#lib/rack/cors/result.rb:9
Rack::Cors::Result::MISS_NO_PATH = T.let(T.unsafe(nil), String)

# pkg:gem/rack-cors#lib/rack/cors/version.rb:5

...
module ActionController
  class << self
    # source://actionpack/7.1.3/lib/action_controller/metal/renderers.rb#7
    def add_renderer(key, &block); end

    # source://actionpack/7.1.3/lib/action_controller/deprecator.rb#4
    def deprecator; end

    # source://actionpack/7.1.3/lib/action_controller/metal/renderers.rb#12
...
class ActionController::API < ::ActionController::Metal
  ...
  class << self
    ...
    # source://actionpack/7.1.3/lib/action_controller/api.rb#106

...
# pkg:gem/mime-types#lib/mime/types.rb:4
module MIME; end
...
#
# pkg:gem/mime-types#lib/mime/type.rb:69
class MIME::Type
  include ::Comparable
  ...
  #
  # pkg:gem/mime-types#lib/mime/type.rb:193
  def <=>(other); end
  ...
  #
  # pkg:gem/mime-types#lib/mime/type.rb:218
  ...
  #
  # pkg:gem/mime-types#lib/mime/type.rb:286
  def content_type; end

  # Returns the default encoding for the MIME::Type based on the media type.
  #
  # pkg:gem/mime-types#lib/mime/type.rb:391
  def default_encoding; end

  # The documentation for this MIME::Type.
  #
  # pkg:gem/mime-types#lib/mime/type.rb:423
  def docs; end
  ...
  # pkg:gem/mime-types#lib/mime/type.rb:380
  ...
  #
  # pkg:gem/mime-types#lib/mime/type.rb:325
  def extensions; end

  # pkg:gem/mime-types#lib/mime/type.rb:330
  ...
  #
  # pkg:gem/mime-types#lib/mime/type.rb:430
  ...
  # invariant.
  #
  # pkg:gem/mime-types#lib/mime/type.rb:266
  def hash; end
  ...
  #
  # pkg:gem/mime-types#lib/mime/type.rb:455
  def i18n_key; end
  ...
  # This method should be considered a private implementation detail.
  #
  # pkg:gem/mime-types#lib/mime/type.rb:590
  def init_with(coder); end

  # pkg:gem/mime-types#lib/mime/type.rb:609
  def inspect; end
  ...
  #   audio/QCELP       => audio
  #
  # pkg:gem/mime-types#lib/mime/type.rb:299
  def media_type; end
  ...
  #
  # pkg:gem/mime-types#lib/mime/type.rb:413
  def obsolete; end
  ...
  # pkg:gem/mime-types#lib/mime/type.rb:352
  def preferred_extension; end

  # pkg:gem/mime-types#lib/mime/type.rb:357
  ...
  #
  # pkg:gem/mime-types#lib/mime/type.rb:203
  ...
  #
  # pkg:gem/mime-types#lib/mime/type.rb:493
  def provisional; end

  # pkg:gem/mime-types#lib/mime/type.rb:496
  ...
  #   audio/QCELP       => audio
  #
  # pkg:gem/mime-types#lib/mime/type.rb:305
  ...
  #   audio/QCELP       => qcelp
  #
  # pkg:gem/mime-types#lib/mime/type.rb:317
  ...
  #
  # pkg:gem/mime-types#lib/mime/type.rb:481
  def registered; end
  ...
  #   audio/QCELP       => audio/qcelp
  #
  # pkg:gem/mime-types#lib/mime/type.rb:293
  def simplified; end
  ...
  #   audio/QCELP       => QCELP
  #
  # pkg:gem/mime-types#lib/mime/type.rb:311
  def sub_type; end

  # Converts the MIME::Type to a hash. The output of this method can also be
  # used to initialize a MIME::Type.
  #
  # pkg:gem/mime-types#lib/mime/type.rb:551
  def to_h; end

  # Converts the MIME::Type to a JSON string.
  #
  # pkg:gem/mime-types#lib/mime/type.rb:544
  def to_json(*args); end

  # Returns the MIME::Type as a string.
  #
  # pkg:gem/mime-types#lib/mime/type.rb:531
  def to_s; end
  ...
  #
  # pkg:gem/mime-types#lib/mime/type.rb:539
  def to_str; end
  ...
  # pkg:gem/mime-types#lib/mime/type.rb:466
  def xrefs=(xrefs); end

  private

  # pkg:gem/mime-types#lib/mime/type.rb:662
  def clear_sort_priority; end

  # pkg:gem/mime-types#lib/mime/type.rb:693
  ...
  #
  # pkg:gem/mime-types#lib/mime/type.rb:710
  ...
  #
  # pkg:gem/mime-types#lib/mime/type.rb:682
  def update_sort_priority; end

  # pkg:gem/mime-types#lib/mime/type.rb:721
  def xref_map(values, helper); end

  # pkg:gem/mime-types#lib/mime/type.rb:729
  def xref_url_for_draft(value); end

  # pkg:gem/mime-types#lib/mime/type.rb:737
  def xref_url_for_person(value); end

  # pkg:gem/mime-types#lib/mime/type.rb:725
  def xref_url_for_rfc(value); end

  # pkg:gem/mime-types#lib/mime/type.rb:733
  def xref_url_for_rfc_errata(value); end

  # pkg:gem/mime-types#lib/mime/type.rb:741
...
class MIME::Type::Columnar < ::MIME::Type
  ...
  # pkg:gem/mime-types#lib/mime/type/columnar.rb:29
  def docs(*args); end

  # pkg:gem/mime-types#lib/mime/type/columnar.rb:29
  def docs=(*args); end

  # pkg:gem/mime-types#lib/mime/type/columnar.rb:45
  def encode_with(coder); end
  ...
  # pkg:gem/mime-types#lib/mime/type/columnar.rb:56
  def update_sort_priority; end
...
class MIME::Type::InvalidContentType < ::ArgumentError
  ...
  # pkg:gem/mime-types#lib/mime/type.rb:78
  def to_s; end
end
...
class MIME::Type::InvalidEncoding < ::ArgumentError
  ...
  # pkg:gem/mime-types#lib/mime/type.rb:91
  def to_s; end
end

# pkg:gem/mime-types#lib/mime/type.rb:108
MIME::Type::MEDIA_TYPE_RE = T.let(T.unsafe(nil), Regexp)

# The released version of the mime-types library.
#
# pkg:gem/mime-types#lib/mime/types/version.rb:12
...
#
# pkg:gem/mime-types#lib/mime/types.rb:6
class MIME::Types
  include ::Enumerable
  extend ::Enumerable
  ...
  #
  # pkg:gem/mime-types#lib/mime/types.rb:166
  def add(*types); end
  ...
  #
  # pkg:gem/mime-types#lib/mime/types.rb:187
  def add_type(type, quiet = T.unsafe(nil)); end

  # Returns the number of known type variants.
  #
  # pkg:gem/mime-types#lib/mime/types.rb:78
  def count; end

  # Iterates through the type variants.
  #
  # pkg:gem/mime-types#lib/mime/types.rb:87
  def each; end
  ...
  #     => [application/xml, image/gif, text/xml]
  #
  # pkg:gem/mime-types#lib/mime/types.rb:148
  def type_for(filename); end

  private

  # pkg:gem/mime-types#lib/mime/types.rb:204
  def add_type_variant!(mime_type); end

  # pkg:gem/mime-types#lib/mime/types.rb:214
  def index_extensions!(mime_type); end

  # pkg:gem/mime-types#lib/mime/types.rb:224
  def match(pattern); end

  # pkg:gem/mime-types#lib/mime/types.rb:218
  def prune_matches(matches, complete, registered); end

  # pkg:gem/mime-types#lib/mime/types.rb:208
  def reindex_extensions!(mime_type); end

  class << self
    # MIME::Types#[] against the default MIME::Types registry.
    #
    # pkg:gem/mime-types#lib/mime/types/registry.rb:16
    def [](type_id, complete: T.unsafe(nil), registered: T.unsafe(nil)); end

    # MIME::Types#add against the default MIME::Types registry.
    #
    # pkg:gem/mime-types#lib/mime/types/registry.rb:41
    def add(*types); end

    # MIME::Types#count against the default MIME::Types registry.
    #
    # pkg:gem/mime-types#lib/mime/types/registry.rb:21
    def count; end

    # Used to mark a method as deprecated in the mime-types interface.
    #
    # pkg:gem/mime-types#lib/mime/types/deprecations.rb:7
    def deprecated(options = T.unsafe(nil), &block); end

    # MIME::Types#each against the default MIME::Types registry.
    #
    # pkg:gem/mime-types#lib/mime/types/registry.rb:26
    def each; end
    ...
    # MIME::Types#type_for against the default MIME::Types registry.
    #
    # pkg:gem/mime-types#lib/mime/types/registry.rb:35
    def type_for(filename); end
    ...
    # pkg:gem/mime-types#lib/mime/types/registry.rb:77
    ...
    # pkg:gem/mime-types#lib/mime/types/registry.rb:67
    def load_default_mime_types(mode = T.unsafe(nil)); end

    # pkg:gem/mime-types#lib/mime/types/registry.rb:62
    def load_mode; end

    # pkg:gem/mime-types#lib/mime/types/registry.rb:81
...
class MIME::Types::Cache < ::Struct
  ...
  class << self
    ...
    #
    # pkg:gem/mime-types#lib/mime/types/cache.rb:17
    ...
    #
    # pkg:gem/mime-types#lib/mime/types/cache.rb:46
...
module MIME::Types::Columnar
  ...
  #
  # pkg:gem/mime-types#lib/mime/types/_columnar.rb:26
  def load_base_data(path); end

  private

  # pkg:gem/mime-types#lib/mime/types/_columnar.rb:169
  def arr(line); end

  # pkg:gem/mime-types#lib/mime/types/_columnar.rb:136
  def dict(line, transform: T.unsafe(nil)); end

  # pkg:gem/mime-types#lib/mime/types/_columnar.rb:165
  def dict_array(h, k, v); end

  # pkg:gem/mime-types#lib/mime/types/_columnar.rb:153
  def dict_extension_priority(h, k, v); end

  # pkg:gem/mime-types#lib/mime/types/_columnar.rb:70
  def each_file_byte(name); end

  # pkg:gem/mime-types#lib/mime/types/_columnar.rb:48
  def each_file_line(name, lookup = T.unsafe(nil)); end

  # pkg:gem/mime-types#lib/mime/types/_columnar.rb:181
  def flag(line); end

  # pkg:gem/mime-types#lib/mime/types/_columnar.rb:96
  def load_docs; end

  # pkg:gem/mime-types#lib/mime/types/_columnar.rb:89
  def load_encoding; end

  # pkg:gem/mime-types#lib/mime/types/_columnar.rb:108
  def load_flags; end

  # pkg:gem/mime-types#lib/mime/types/_columnar.rb:124
  def load_friendly; end

  # pkg:gem/mime-types#lib/mime/types/_columnar.rb:102
  def load_preferred_extension; end

  # pkg:gem/mime-types#lib/mime/types/_columnar.rb:130
  def load_use_instead; end

  # pkg:gem/mime-types#lib/mime/types/_columnar.rb:118
  def load_xrefs; end

  # pkg:gem/mime-types#lib/mime/types/_columnar.rb:177
  def opt(line); end

  class << self
    # pkg:gem/mime-types#lib/mime/types/_columnar.rb:15
    def extended(obj); end
  end
end

# pkg:gem/mime-types#lib/mime/types/_columnar.rb:13
...
class MIME::Types::Container
  ...
  # pkg:gem/mime-types#lib/mime/types/container.rb:47
  def ==(other); end

  # pkg:gem/mime-types#lib/mime/types/container.rb:17
  def [](key); end

  # pkg:gem/mime-types#lib/mime/types/container.rb:21
  def []=(key, value); end

  # pkg:gem/mime-types#lib/mime/types/container.rb:91
  def add(key, value); end

  # pkg:gem/mime-types#lib/mime/types/container.rb:51
  def count(*args, &block); end

  # pkg:gem/mime-types#lib/mime/types/container.rb:65
  def each(&block); end

  # pkg:gem/mime-types#lib/mime/types/container.rb:61
  ...
  # pkg:gem/mime-types#lib/mime/types/container.rb:103
  def encode_with(coder); end

  # pkg:gem/mime-types#lib/mime/types/container.rb:75
  def flat_map(&block); end

  # pkg:gem/mime-types#lib/mime/types/container.rb:107
  def init_with(coder); end

  # pkg:gem/mime-types#lib/mime/types/container.rb:79
  def keys; end

  # pkg:gem/mime-types#lib/mime/types/container.rb:95
  def marshal_dump; end

  # pkg:gem/mime-types#lib/mime/types/container.rb:99
  def marshal_load(hash); end

  # pkg:gem/mime-types#lib/mime/types/container.rb:31
  def merge(other); end

  # pkg:gem/mime-types#lib/mime/types/container.rb:35
  def merge!(other); end

  # pkg:gem/mime-types#lib/mime/types/container.rb:87
  def select(&block); end

  # pkg:gem/mime-types#lib/mime/types/container.rb:43
  def to_hash; end

  # pkg:gem/mime-types#lib/mime/types/container.rb:83
  def values; end
  ...
  # pkg:gem/mime-types#lib/mime/types/container.rb:116
  def normalize; end
end

# pkg:gem/mime-types#lib/mime/types/container.rb:124
...
#
# pkg:gem/mime-types#lib/mime/types/loader.rb:22
class MIME::Types::Loader
  ...
  #
  # pkg:gem/mime-types#lib/mime/types/loader.rb:27
  def container; end
  ...
  #
  # pkg:gem/mime-types#lib/mime/types/loader.rb:59
  def load_json; end
  ...
  #
  # pkg:gem/mime-types#lib/mime/types/loader.rb:46
  def load_yaml; end

  # The path that will be read for the MIME::Types files.
  #
  # pkg:gem/mime-types#lib/mime/types/loader.rb:24
  def path; end

  private

  # pkg:gem/mime-types#lib/mime/types/loader.rb:156
  def columnar_path; end

  # pkg:gem/mime-types#lib/mime/types/loader.rb:152
  def json_path; end

  # pkg:gem/mime-types#lib/mime/types/loader.rb:148
  def yaml_path; end

  class << self
    # Loads the default MIME::Type registry.
    #
    # pkg:gem/mime-types#lib/mime/types/loader.rb:92
    def load(options = T.unsafe(nil)); end
    ...
    # shipped with the mime-types library.
    #
    # pkg:gem/mime-types#lib/mime/types/loader.rb:126
    ...
    # NOTE: The purpose of this format is purely for maintenance reasons.
    #
    # pkg:gem/mime-types#lib/mime/types/loader.rb:105
    ...
    # pkg:gem/mime-types#lib/mime/types/loader.rb:133
...
class MIME::Types::NullLogger < ::Logger
  ...
  # pkg:gem/mime-types#lib/mime/types/logger.rb:62
  def add(_severity, _message = T.unsafe(nil), _progname = T.unsafe(nil)); end

  # pkg:gem/mime-types#lib/mime/types/logger.rb:59
  def close; end

  # pkg:gem/mime-types#lib/mime/types/logger.rb:52
  def reopen(_); end
end

# The released version of the mime-types library.
#
# pkg:gem/mime-types#lib/mime/types/version.rb:7
...
class MIME::Types::WarnLogger::WarnLogDevice < ::Logger::LogDevice
  ...
  # pkg:gem/mime-types#lib/mime/types/logger.rb:31
  def write(m); end
end

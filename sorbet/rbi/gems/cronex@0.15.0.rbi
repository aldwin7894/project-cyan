...
# pkg:gem/cronex#lib/cronex/version.rb:1
module Cronex; end

# pkg:gem/cronex#lib/cronex/exp_descriptor.rb:5
Cronex::CASINGS = T.let(T.unsafe(nil), Array)

# pkg:gem/cronex#lib/cronex/exp_descriptor.rb:10
Cronex::CRONEX_OPTS = T.let(T.unsafe(nil), Hash)

# pkg:gem/cronex#lib/cronex/parser.rb:3
Cronex::DAYS = T.let(T.unsafe(nil), Array)

# abbr dayname => long dayname
#
# pkg:gem/cronex#lib/cronex/parser.rb:10
Cronex::DAY_DAY = T.let(T.unsafe(nil), Hash)

# pkg:gem/cronex#lib/cronex/parser.rb:6
Cronex::DAY_NUM = T.let(T.unsafe(nil), Hash)

# pkg:gem/cronex#lib/cronex/description/day_of_month.rb:2
class Cronex::DayOfMonthDescription < ::Cronex::Description
  # pkg:gem/cronex#lib/cronex/description/day_of_month.rb:11
  def between_description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/day_of_month.rb:15
  def description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/day_of_month.rb:7
  def interval_description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/day_of_month.rb:3
  def single_item_description(expression); end

  # pkg:gem/cronex#lib/cronex/description/day_of_month.rb:19
  def starting_description_format(expression); end
end

# pkg:gem/cronex#lib/cronex/description/day_of_week.rb:2
class Cronex::DayOfWeekDescription < ::Cronex::Description
  # pkg:gem/cronex#lib/cronex/description/day_of_week.rb:30
  def between_description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/day_of_week.rb:34
  def description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/day_of_week.rb:26
  def interval_description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/day_of_week.rb:3
  def single_item_description(expression); end

  # pkg:gem/cronex#lib/cronex/description/day_of_week.rb:48
  def starting_description_format(expression); end
end
...
class Cronex::Description
  ...
  # pkg:gem/cronex#lib/cronex/description/base.rb:15
  def segment_description(expression, all_values_description); end

  # pkg:gem/cronex#lib/cronex/description/base.rb:11
...
class Cronex::ExpressionDescriptor
  ...
  # pkg:gem/cronex#lib/cronex/exp_descriptor.rb:111
  def day_of_month_description(expression_parts); end

  # pkg:gem/cronex#lib/cronex/exp_descriptor.rb:101
  ...
  # pkg:gem/cronex#lib/cronex/exp_descriptor.rb:163
  def full_description(expression_parts); end

  # pkg:gem/cronex#lib/cronex/exp_descriptor.rb:91
  def hours_description(expression_parts); end

  # pkg:gem/cronex#lib/cronex/exp_descriptor.rb:86
  ...
  # pkg:gem/cronex#lib/cronex/exp_descriptor.rb:81
  ...
  # pkg:gem/cronex#lib/cronex/exp_descriptor.rb:33
  def to_hash; end

  # pkg:gem/cronex#lib/cronex/exp_descriptor.rb:175
  def transform_case(desc, case_type = T.unsafe(nil)); end

  # pkg:gem/cronex#lib/cronex/exp_descriptor.rb:186
  def transform_verbosity(desc, verbose = T.unsafe(nil)); end

  # pkg:gem/cronex#lib/cronex/exp_descriptor.rb:96
  def year_description(expression_parts); end
end

# pkg:gem/cronex#lib/cronex/errors.rb:2
class Cronex::ExpressionError < ::StandardError; end

# pkg:gem/cronex#lib/cronex/description/hours.rb:2
class Cronex::HoursDescription < ::Cronex::Description
  # pkg:gem/cronex#lib/cronex/description/hours.rb:11
  def between_description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/hours.rb:15
  def description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/hours.rb:7
  def interval_description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/hours.rb:3
  def single_item_description(expression, timezone = T.unsafe(nil)); end

  # pkg:gem/cronex#lib/cronex/description/hours.rb:19
  def starting_description_format(expression); end
end

# pkg:gem/cronex#lib/cronex/parser.rb:4
Cronex::MONTHS = T.let(T.unsafe(nil), Array)

# pkg:gem/cronex#lib/cronex/parser.rb:7
Cronex::MONTH_NUM = T.let(T.unsafe(nil), Hash)

# pkg:gem/cronex#lib/cronex/description/minutes.rb:2
class Cronex::MinutesDescription < ::Cronex::Description
  # pkg:gem/cronex#lib/cronex/description/minutes.rb:11
  def between_description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/minutes.rb:15
  def description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/minutes.rb:7
  def interval_description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/minutes.rb:23
  def min_plural(expression); end

  # pkg:gem/cronex#lib/cronex/description/minutes.rb:3
  def single_item_description(expression); end

  # pkg:gem/cronex#lib/cronex/description/minutes.rb:19
  def starting_description_format(expression); end
end

# pkg:gem/cronex#lib/cronex/description/month.rb:2
class Cronex::MonthDescription < ::Cronex::Description
  # pkg:gem/cronex#lib/cronex/description/month.rb:11
  def between_description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/month.rb:15
  def description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/month.rb:7
  def interval_description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/month.rb:3
  def single_item_description(expression); end

  # pkg:gem/cronex#lib/cronex/description/month.rb:19
  def starting_description_format(expression); end
end
...
class Cronex::Parser
  ...
  # pkg:gem/cronex#lib/cronex/parser.rb:20
  def parse(exp = T.unsafe(nil)); end

  # pkg:gem/cronex#lib/cronex/parser.rb:50
  def sanitize(exp = T.unsafe(nil)); end
end

# pkg:gem/cronex#lib/cronex/resource.rb:3
...
class Cronex::Resource
  ...
  # pkg:gem/cronex#lib/cronex/resource.rb:28
  def [](key); end

  # pkg:gem/cronex#lib/cronex/resource.rb:31
  def get(key); end
...
# pkg:gem/cronex#lib/cronex/errors.rb:3
class Cronex::ResourceError < ::StandardError; end

# pkg:gem/cronex#lib/cronex/exp_descriptor.rb:6
Cronex::SEGMENTS = T.let(T.unsafe(nil), Array)

# pkg:gem/cronex#lib/cronex/exp_descriptor.rb:8
Cronex::SPECIAL_CHARS = T.let(T.unsafe(nil), Array)

# pkg:gem/cronex#lib/cronex/description/seconds.rb:2
class Cronex::SecondsDescription < ::Cronex::Description
  # pkg:gem/cronex#lib/cronex/description/seconds.rb:11
  def between_description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/seconds.rb:15
  def description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/seconds.rb:7
  def interval_description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/seconds.rb:3
  def single_item_description(expression); end

  # pkg:gem/cronex#lib/cronex/description/seconds.rb:19
  def starting_description_format(expression); end
end

# pkg:gem/cronex#lib/cronex/utils.rb:4
module Cronex::Utils
  extend ::Cronex::Utils

  # pkg:gem/cronex#lib/cronex/utils.rb:25
  def day_of_week_name(number); end

  # pkg:gem/cronex#lib/cronex/utils.rb:29
...
# pkg:gem/cronex#lib/cronex/version.rb:2
Cronex::VERSION = T.let(T.unsafe(nil), String)

# pkg:gem/cronex#lib/cronex/description/year.rb:2
class Cronex::YearDescription < ::Cronex::Description
  # pkg:gem/cronex#lib/cronex/description/year.rb:11
  def between_description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/year.rb:15
  def description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/year.rb:7
  def interval_description_format(expression); end

  # pkg:gem/cronex#lib/cronex/description/year.rb:3
  def single_item_description(expression); end

  # pkg:gem/cronex#lib/cronex/description/year.rb:19
  def starting_description_format(expression); end
end

...
# This is an autogenerated file for dynamic methods in `AnilistUserStatisticsSyncJob`.
# Please instead update this file by running `bin/tapioca dsl AnilistUserStatisticsSyncJob`.
